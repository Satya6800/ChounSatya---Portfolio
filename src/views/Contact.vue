      ...
      <div class="contact-grid">
        <div class="feature-panel">
          ...
          <div class="social-row">
            <a href="https://www.linkedin.com/in/choun-satya-68587534a" class="social-btn" title="LinkedIn" target="_blank" rel="noreferrer">
            ...
            <a href="https://t.me/satyachoun" class="social-btn" title="Telegram" target="_blank" rel="noreferrer">
              <svg viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="telegramGradient" x1="128" y1="0" x2="128" y2="256" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#2AABEE"/>
                    <stop offset="1" stop-color="#229ED9"/>
                  </linearGradient>
                </defs>
                <path fill="url(#telegramGradient)" d="M128 0C94.06 0 61.48 13.494 37.5 37.49A128.038 128.038 0 0 0 0 128c0 33.934 13.5 66.514 37.5 90.51C61.48 242.506 94.06 256 128 256s66.52-13.494 90.5-37.49c24-23.996 37.5-56.576 37.5-90.51 0-33.934-13.5-66.514-37.5-90.51C194.52 13.494 161.94 0 128 0Z"/>
            ...
            <a href="https://www.facebook.com/share/16kTkSWDKK/?mibextid=wwXIfr" class="social-btn" title="Facebook" target="_blank" rel="noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://github.com/Satya6800" class="social-btn" title="GitHub" target="_blank" rel="noreferrer">
        ...
        <div class="contact-card contact-info">
          ...
          <div class="quick-features">
            ...
            <div class="pill">Project planning</div>
            <div class="pill">Trusted partner</div>
          </div>
        </div>
...
.contact-page {
  ...
  color: #eef2ff;
  background: radial-gradient(circle at top right, rgba(0, 212, 255, 0.14), transparent 26%),
              radial-gradient(circle at bottom left, rgba(139, 92, 246, 0.14), transparent 30%),
              linear-gradient(160deg, #071119 0%, #0a1f3a 100%);
  overflow: hidden;
...
.bubble:nth-child(1)  { width:14px; height:14px; left:5%;  bottom:-11%; animation-duration:9s;  animation-delay:0s; }
.bubble:nth-child(2)  { width:22px; height:22px; left:15%; bottom:-10%; animation-duration:12s; animation-delay:1.5s; }
.bubble:nth-child(3)  { width:10px; height:10px; left:24%; bottom:-8%; animation-duration:8s; animation-delay:2.1s; }
.bubble:nth-child(4)  { width:28px; height:28px; left:37%; bottom:-12%; animation-duration:14s; animation-delay:0.7s; }
.bubble:nth-child(5)  { width:18px; height:18px; left:50%; bottom:-9%; animation-duration:9s; animation-delay:1.7s; }
.bubble:nth-child(6)  { width:12px; height:12px; left:64%; bottom:-10%; animation-duration:11s; animation-delay:2.9s; }
.bubble:nth-child(7)  { width:24px; height:24px; left:73%; bottom:-11%; animation-duration:13s; animation-delay:0.9s; }
.bubble:nth-child(8)  { width:16px; height:16px; left:84%; bottom:-12%; animation-duration:10s; animation-delay:2.4s; }
.bubble:nth-child(9)  { width:8px;  height:8px;  left:92%; bottom:-8%; animation-duration:7s; animation-delay:1.2s; }
.bubble:nth-child(10) { width:34px; height:34px; left:44%; bottom:-13%; animation-duration:16s; animation-delay:4.1s; }
