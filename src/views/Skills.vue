...
.skills-page {
  ...
  background: radial-gradient(circle at top left, rgba(5, 160, 255, 0.18), transparent 28%),
              radial-gradient(circle at bottom right, rgba(123, 104, 238, 0.14), transparent 30%),
              linear-gradient(160deg, #081125 0%, #0e1734 100%);
  overflow: hidden;
...
.skill-card:hover {
  ...
  box-shadow: 0 28px 80px rgba(7, 23, 68, 0.22);
}
...
.skill-icon {
  ...
  margin-bottom: 22px;
  color: #fff;
  background: linear-gradient(135deg, rgba(14, 165, 233, 0.18), rgba(79, 70, 229, 0.18));
...
.tool-card:hover {
  ...
  box-shadow: 0 18px 40px rgba(7, 23, 68, 0.16);
}
